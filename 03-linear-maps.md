...
$$
\lambda(p,(x_1,x_2,x_3))
=(\lambda p,(\lambda x_1,\lambda x_2,\lambda x_3)).
$$
...
=
\{(x_1,x_2,0,0,0)\in\mathbb{R}^5:x_1,x_2\in\mathbb{R}\}
$$
...
=
\{p\in\mathcal{P}_5(\mathbb{R}):p(8)=0\}.
$$

28. $V$가 유한차원이고 $\varphi_1,\ldots,\varphi_m$이 $V'$에서 선형독립인 리스트라고 하자. 다음을 증명하라.

$$
\dim((\operatorname{null}\varphi_1)\cap\cdots\cap(\operatorname{null}\varphi_m))
=
(\dim V)-m.
$$
