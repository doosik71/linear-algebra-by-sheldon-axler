...
$T \in \mathcal{L}(V,W)$이면 $\operatorname{null}T$는 $V$의 부분공간이다.

증명. $T0=0$이므로 $0\in\operatorname{null}T$이다. $u,v\in\operatorname{null}T$이면
$$
T(u+v)=Tu+Tv=0
$$
이므로 $u+v\in\operatorname{null}T$이다. $\lambda\in\mathbb{F}$이면
$$
T(\lambda u)=\lambda Tu=0
$$
이므로 $\lambda u\in\operatorname{null}T$이다.
...
$$
T\text{가 단사} \quad \Longleftrightarrow \quad \operatorname{null}T=\{0\}.
$$

증명. $T$가 단사이면 $Tv=0=T0$에서 $v=0$이므로 영공간은 $\{0\}$이다. 반대로 $\operatorname{null}T=\{0\}$이고 $Tu=Tv$이면 $T(u-v)=0$이므로 $u-v=0$, 따라서 $u=v$이다.
...
$T \in \mathcal{L}(V,W)$이면 $\operatorname{range}T$는 $W$의 부분공간이다.

증명. $T0=0$이므로 $0$은 치역에 속한다. $w_1=Tv_1$, $w_2=Tv_2$이면 $w_1+w_2=T(v_1+v_2)$이고, $\lambda w_1=T(\lambda v_1)$이다. 따라서 치역은 덧셈과 스칼라곱에 닫혀 있다.

**3.19 정의: 전사**

$T:V\to W$의 치역이 $W$ 전체이면 $T$를 **전사**라고 한다. 즉 $\operatorname{range}T=W$이다.
...
$V$가 유한차원이고 $T \in \mathcal{L}(V,W)$라 하자. 그러면 $\operatorname{range}T$는 유한차원이고
$$
\dim V=\dim\operatorname{null}T+\dim\operatorname{range}T.
$$

증명. $\operatorname{null}T$의 기저 $u_1,\ldots,u_m$을 $V$의 기저
$$
u_1,\ldots,u_m,v_1,\ldots,v_n
$$
으로 확장한다. 그러면 $Tv_1,\ldots,Tv_n$이 $\operatorname{range}T$의 기저임을 보이면 된다.

먼저 $w\in\operatorname{range}T$라 하자. $w=Tv$이고
$$
...
$$
이면 $T(c_1v_1+\cdots+c_nv_n)=0$이므로 $c_1v_1+\cdots+c_nv_n\in\operatorname{null}T$이다. 기저의 선형독립성 때문에 모든 $c_j=0$이다. 따라서 $Tv_1,\ldots,Tv_n$은 선형독립이다. 그러므로 $\dim\operatorname{range}T=n$이고 $\dim V=m+n$이다.

**3.22 낮은 차원으로 가는 선형사상은 단사일 수 없다**

$V$와 $W$가 유한차원이고 $\dim V>\dim W$이며 $T \in \mathcal{L}(V,W)$이면 $T$는 단사가 아니다.

증명. 만약 $T$가 단사이면 $\dim\operatorname{null}T=0$이다. 기본정리에 의해 $\dim V=\dim\operatorname{range}T\le \dim W$가 되어 모순이다.
...
증명. $\dim\operatorname{range}T\le \dim V<\dim W$이므로 $\operatorname{range}T\ne W$이다.
...
증명. 위의 $T:\mathbb{F}^n\to\mathbb{F}^m$에서 $n>m$이면 3.22에 의해 $T$는 단사가 아니므로 $\operatorname{null}T$에 $0$이 아닌 벡터가 있다.
...
1. $\dim\operatorname{null}T=3$이고 $\dim\operatorname{range}T=2$인 선형사상 $T$의 예를 들어라.

2. $S,T \in \mathcal{L}(V)$이고 $\operatorname{range}S \subseteq \operatorname{null}T$라 하자. $(ST)^2=0$임을 증명하라.
...
4. $\{T\in\mathcal{L}(\mathbb{R}^5,\mathbb{R}^4):\dim\operatorname{null}T>2\}$가 $\mathcal{L}(\mathbb{R}^5,\mathbb{R}^4)$의 부분공간이 아님을 보여라.

5. $\operatorname{range}T=\operatorname{null}T$인 $T\in\mathcal{L}(\mathbb{R}^4)$의 예를 들어라.

6. $\operatorname{range}T=\operatorname{null}T$인 $T\in\mathcal{L}(\mathbb{R}^5)$가 존재하지 않음을 증명하라.
...
10. $v_1,\ldots,v_n$이 $V$를 생성하고 $T\in\mathcal{L}(V,W)$라 하자. $Tv_1,\ldots,Tv_n$이 $\operatorname{range}T$를 생성함을 보여라.
...
13. $U$가 $\mathbb{R}^8$의 3차원 부분공간이고 $T:\mathbb{R}^8\to\mathbb{R}^5$가 선형이며 $\operatorname{null}T=U$라 하자. $T$가 전사임을 증명하라.
...
18. $V,W$가 유한차원이고 $U$가 $V$의 부분공간이라고 하자. $\operatorname{null}T=U$인 $T\in\mathcal{L}(V,W)$가 존재할 필요충분조건은
    $$
...
24. (a) $\dim V=5$이고 $S,T\in\mathcal{L}(V)$이며 $ST=0$이라 하자. $\dim\operatorname{range}TS\le2$임을 증명하라.

    (b) $ST=0$이고 $\dim\operatorname{range}TS=2$인 $S,T\in\mathcal{L}(\mathbb{F}^5)$의 예를 들어라.

25. $W$가 유한차원이고 $S,T\in\mathcal{L}(V,W)$라 하자. $\operatorname{null}S\subseteq\operatorname{null}T$일 필요충분조건은 $T=ES$가 되도록 하는 $E\in\mathcal{L}(W)$가 존재하는 것임을 증명하라.

26. $V$가 유한차원이고 $S,T\in\mathcal{L}(V,W)$라 하자. $\operatorname{range}S\subseteq\operatorname{range}T$일 필요충분조건은 $S=TE$가 되도록 하는 $E\in\mathcal{L}(V)$가 존재하는 것임을 증명하라.
...
30. $\varphi\in\mathcal{L}(V,\mathbb{F})$이고 $\varphi\ne0$라 하자. $u\in V$가 $\operatorname{null}\varphi$에 속하지 않으면
    $$
    V=\operatorname{null}\varphi\oplus\{au:a\in\mathbb{F}\}
    $$
    임을 증명하라.

31. $V$가 유한차원이고 $X$가 $V$의 부분공간이며 $Y$가 $W$의 유한차원 부분공간이라고 하자. $\operatorname{null}T=X$이고 $\operatorname{range}T=Y$인 $T\in\mathcal{L}(V,W)$가 존재할 필요충분조건은
    $$
    \dim X+\dim Y=\dim V
    $$
    임을 증명하라.
...
33. $V,W$가 실벡터공간이고 $T\in\mathcal{L}(V,W)$라 하자. 모든 $u,v\in V$에 대해
    ...
    (c) $\operatorname{range}T_{\mathbb{C}}=W_{\mathbb{C}}$일 필요충분조건은 $\operatorname{range}T=W$인 것임을 보여라.
...
1. $T\in\mathcal{L}(V,W)$라 하자. $V$와 $W$의 어떤 기저를 선택하더라도 $T$의 행렬은 적어도 $\dim\operatorname{range}T$개의 $0$이 아닌 성분을 가짐을 보여라.

2. $V,W$가 유한차원이고 $0$이 아니며 $T\in\mathcal{L}(V,W)$라 하자. $\dim\operatorname{range}T=1$일 필요충분조건은 어떤 $V$의 기저와 $W$의 기저가 존재하여 그 기저들에 대한 $\mathcal{M}(T)$의 모든 성분이 $1$이 되는 것임을 증명하라.
...
5. $V,W$가 유한차원이고 $T\in\mathcal{L}(V,W)$라 하자. 어떤 $V$의 기저와 $W$의 기저를 고르면 $\mathcal{M}(T)$의 성분 중 $1\le k\le\dim\operatorname{range}T$에 대해 $k$행 $k$열 성분만 $1$이고 나머지는 모두 $0$이 되도록 할 수 있음을 증명하라.
...
$T$가 단사이면 $\dim\operatorname{null}T=0$이므로 $\dim\operatorname{range}T=\dim V=\dim W$이고, 따라서 $T$는 전사이다. 반대로 $T$가 전사이면 $\dim\operatorname{range}T=\dim W=\dim V$이므로 $\dim\operatorname{null}T=0$이고, 따라서 $T$는 단사이다. 3.63에 의해 가역성과도 동치이다.
...
증명. $V$와 $W$가 동형이면 어떤 동형사상 $T:V\to W$가 존재한다. 그러면 $\operatorname{null}T=\{0\}$이고 $\operatorname{range}T=W$이므로 기본정리에 의해 $\dim V=\dim W$이다.
...
**3.78 $\dim\operatorname{range}T$는 $\mathcal{M}(T)$의 열계수와 같다**

$V,W$가 유한차원이고 $T\in\mathcal{L}(V,W)$라 하자. 그러면
$$
\dim\operatorname{range}T = \text{$\mathcal{M}(T)$의 열계수}.
$$
...
6. $W$가 유한차원이고 $S,T\in\mathcal{L}(V,W)$라 하자. $\operatorname{null}S=\operatorname{null}T$일 필요충분조건은 $S=ET$가 되도록 하는 가역 $E\in\mathcal{L}(W)$가 존재하는 것임을 증명하라.

7. $V$가 유한차원이고 $S,T\in\mathcal{L}(V,W)$라 하자. $\operatorname{range}S=\operatorname{range}T$일 필요충분조건은 $S=TE$가 되도록 하는 가역 $E\in\mathcal{L}(V)$가 존재하는 것임을 증명하라.
...
17. $V$가 유한차원이고 $S\in\mathcal{L}(V)$라 하자. $\mathcal{A}\in\mathcal{L}(\mathcal{L}(V))$를
    ...
    (a) $\dim\operatorname{null}\mathcal{A}=(\dim V)(\dim\operatorname{null}S)$임을 보여라.

    (b) $\dim\operatorname{range}\mathcal{A}=(\dim V)(\dim\operatorname{range}S)$임을 보여라.
...
$T\in\mathcal{L}(V,W)$라 하자. $\operatorname{null}T$에 의한 몫공간에서 $W$로 가는 사상
$$
...
$T\in\mathcal{L}(V,W)$이고 $\pi$가 $V$에서 $V/\operatorname{null}T$로 가는 몫사상이라고 하자. 그러면 다음이 성립한다.
...
(d) $V/\operatorname{null}T$와 $\operatorname{range}T$는 동형이다.

증명. (a)는 정의에서 바로 나온다. (b)는 $\widetilde{T}(v+\operatorname{null}T)=0$이면 $Tv=0$이고, 따라서 $v\in\operatorname{null}T$이므로 $v+\operatorname{null}T=\operatorname{null}T$라는 사실에서 따른다. (c)도 정의에서 바로 나오며, (b)와 (c)가 (d)를 준다.
...
1. 함수 $T:V\to W$의 그래프를
   ...
   $$
   로 정의한다. $T$가 선형사상일 필요충분조건은 $\operatorname{graph}T$가 $V\times W$의 부분공간인 것임을 증명하라.
...
8. (a) $T\in\mathcal{L}(V,W)$이고 $c\in W$라 하자. $\{x\in V:Tx=c\}$는 공집합이거나 $\operatorname{null}T$의 평행이동임을 증명하라.
...
17. $U$가 $V$의 부분공간이고 $\dim V/U=1$이라 하자. $\operatorname{null}\varphi=U$가 되도록 하는 $\varphi\in\mathcal{L}(V,\mathbb{F})$가 존재함을 증명하라.
...
19. $T\in\mathcal{L}(V,W)$이고 $U$가 $V$의 부분공간이라고 하자. $\pi$를 $V$에서 $V/U$로 가는 몫사상이라 하자. $T=S\circ\pi$가 되도록 하는 $S\in\mathcal{L}(V/U,W)$가 존재할 필요충분조건은 $U\subseteq\operatorname{null}T$임을 증명하라.
...
$$
U=\operatorname{span}(e_1,e_2) = \{(x_1,x_2,0,0,0)\in\mathbb{R}^5:x_1,x_2\in\mathbb{R}\}
$$
이면
$$
...
여기서 $\operatorname{null}i'=U^0$이고 $\dim V'=\dim V$이다. 또한 $U$ 위의 모든 선형함수는 $V$ 위의 선형함수로 확장될 수 있으므로 $\operatorname{range}i'=U'$이다. 따라서
$$
\dim U+\dim U^0=\dim V.
$$
...
증명. (a) $\varphi\in\operatorname{null}T'$이면 $\varphi\circ T=0$이므로 $\varphi$는 $\operatorname{range}T$의 모든 벡터에서 $0$이 된다. 따라서 $\varphi\in(\operatorname{range}T)^0$이다. 반대 포함도 같은 문장을 거꾸로 읽으면 된다.

(b)
$$
\dim\operatorname{null}T' =\dim(\operatorname{range}T)^0 =\dim W-\dim\operatorname{range}T =\dim W-(\dim V-\dim\operatorname{null}T).
$$
...
(b) 먼저 $\varphi=T'(\psi)$라 하자. $v\in\operatorname{null}T$이면
$$
\varphi(v)=(T'\psi)(v)=(\psi\circ T)(v)=\psi(0)=0
$$
이므로 $\operatorname{range}T'\subseteq(\operatorname{null}T)^0$이다. 두 공간의 차원은
$$
...
$$
\text{$A$의 열계수} =\dim\operatorname{range}T =\dim\operatorname{range}T' =\text{$\mathcal{M}(T')$의 열계수} =\text{$A^t$의 열계수} =\text{$A$의 행계수}.
$$
...
5. $T\in\mathcal{L}(V,W)$이고 $w_1,\ldots,w_m$이 $\operatorname{range}T$의 기저라고 하자. 각 $v\in V$에 대해
   $$
...
6. $\varphi,\beta\in V'$라 하자. $\operatorname{null}\varphi\subseteq\operatorname{null}\beta$일 필요충분조건은 $\beta=c\varphi$가 되도록 하는 $c\in\mathbb{F}$가 존재하는 것임을 증명하라.
...
23. $V$가 유한차원이고 $\varphi_1,\ldots,\varphi_m\in V'$라 하자. 다음 세 집합이 서로 같음을 증명하라.
    ...
    (b) $((\operatorname{null}\varphi_1)\cap\cdots\cap(\operatorname{null}\varphi_m))^0$
...
27. $T\in\mathcal{L}(\mathcal{P}_5(\mathbb{R}))$이고 $\operatorname{null}T'=\operatorname{span}(\varphi)$라고 하자. 여기서 $\varphi$는 $\varphi(p)=p(8)$로 정의된 $\mathcal{P}_5(\mathbb{R})$ 위의 선형함수이다. 다음을 증명하라.

    $$
    \operatorname{range}T = \{p\in\mathcal{P}_5(\mathbb{R}):p(8)=0\}.
    $$

28. $V$가 유한차원이고 $\varphi_1,\ldots,\varphi_m$이 $V'$에서 선형독립인 리스트라고 하자. 다음을 증명하라.

    $$
    \dim((\operatorname{null}\varphi_1)\cap\cdots\cap(\operatorname{null}\varphi_m)) = (\dim V)-m.
    $$

29. $V,W$가 유한차원이고 $T\in\mathcal{L}(V,W)$라 하자.

    (a) $\varphi\in W'$이고 $\operatorname{null}T'=\operatorname{span}(\varphi)$이면 $\operatorname{range}T=\operatorname{null}\varphi$임을 증명하라.

    (b) $\psi\in V'$이고 $\operatorname{range}T'=\operatorname{span}(\psi)$이면 $\operatorname{null}T=\operatorname{null}\psi$임을 증명하라.
...
31. $U$가 $V$의 부분공간이라고 하자. 포함사상 $i:U\to V$를 $i(u)=u$로 정의한다. 그러면 $i'\in\mathcal{L}(V',U')$이다.
    ...
    (a) $\operatorname{null}i'=U^0$임을 보여라.

    (b) $V$가 유한차원이면 $\operatorname{range}i'=U'$임을 증명하라.
...
33. $U$가 $V$의 부분공간이라고 하자. $\pi:V\to V/U$를 보통의 몫사상이라 하자. 그러면 $\pi'\in\mathcal{L}((V/U)',V')$이다.
    ...
    (b) $\operatorname{range}\pi'=U^0$임을 보여라.
